    ...
    >
      ...
      >
        ...
        <div className="sm:w-1/2 w-full p-8 sm:p-12 relative flex flex-col h-full sm:h-auto">
          ...
          <h4 className="text-lg font-semibold text-gray-900">Log in to your account</h4>
          ...
          {/* Forgot Password */}
          <div className="mt-3 mb-12 text-right">
            <button className="text-sm text-gray-500 hover:text-gray-700">Forgot password?</button>
          </div>

          {/* Login Button */}
          <Button inverted className="w-full mt-4" onClick={handleLogin}>
            Continue
          </Button>
