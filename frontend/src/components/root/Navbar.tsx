    ...
    return (
        <>
            <nav className={clsx(
                ...
                hasScrolled || !transparent ? "bg-[#1a1a1a]/90 backdrop-blur-md" : "bg-transparent"
            )}>
            ...
            >
                <div className="py-5 px-10">
                    <Link href="/create" className="text-white text-xl font-normal transition hover:text-gray-400">Create</Link>
                </div>
                <div className="py-5 px-10">
                    <Link href="/explore" className="text-white text-xl font-normal transition hover:text-gray-400">Explore</Link>
                </div>
            </div>
